...
class Scanner:
    ...
    def insert_uid_and_phone(self, id, phone, uid):
        cursor = self.database_connection.cursor()
        try:
            cursor.execute("INSERT INTO wb VALUES (?, ?, ?);", (id, phone, uid))
    ...
    def start(self):
        ...
        with open(self.file_name, encoding='utf-8') as file:
            ...
            for line in file:
                ...
                phone = data[-1]
                for uid in data[:-1]:
                    self.insert_uid_and_phone(self.handle_total, phone, uid)
...
if __name__ == '__main__':
    scanner = Scanner("database/database.db", "微博5亿2019.txt")
    scanner.start()
